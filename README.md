...
- 流水按日分组、显示当日净额；点击任意流水可编辑或删除

### ⌨️ 快速记账（iCost 式数字键盘）
- 底部抽屉面板：大字金额实时显示（支出红 / 收入绿）
...
- **第二批（交互增强）**：转账 / 组合付款、模板快捷记账、周期记账、账单搜索与多维筛选、标签系统、二级分类、报销与退款关联
- **第三批（数据与平台）**：支付宝 / 微信 CSV 导入、多币种、WebDAV / 自建云同步、存钱计划
- **第四批（体验深化）**：PWA 离线、深色模式、记账图片与位置、年度总结报告
